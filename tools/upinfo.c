...
int main(int argc, char const *argv[])
{
	...
	printf("U1:%.2f U3:%" PRIu32 " U4:%" PRIu32 " U7:%" PRIu32 "", pihdr.flt_unk1, pihdr.u32_unk3, pihdr.u32_unk4,
	       pihdr.u32_unk7);
	printf("\n");
	...
	printf("\n");
	printf("U2:%.2f U3:%.2f U10:%.2f U11:%.2f U12:%.2f U13:%.2f", pidata.flt_unk2, pidata.flt_unk3, pidata.flt_unk10,
	       pidata.flt_unk11, pidata.flt_unk12, pidata.flt_unk13);
	printf("\n");
